...
contract TheFedzTSLA is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit {
    constructor(address recipient, address initialOwner)
        ERC20("The Fedz TSLA", "FTSLA")
        Ownable(initialOwner)
        ERC20Permit("The Fedz TSLA")
    {
        _mint(recipient, 24 * 10 ** decimals());
    }
